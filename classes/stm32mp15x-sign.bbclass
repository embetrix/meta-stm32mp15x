...
do_fip_sign() {
    ...
    install -d  ${DEPLOY_DIR_IMAGE}/fip-certs
    cert_create --rot-key "${SECBOOT_SIGN_KEY}" -n                                                              \
                ...
                --tos-fw-cert        ${DEPLOY_DIR_IMAGE}/fip-certs/tee-header_v2.crt              \
                --trusted-key-cert   ${DEPLOY_DIR_IMAGE}/fip-certs/trusted-key-cert.key-crt       \
                --tos-fw-key-cert    ${DEPLOY_DIR_IMAGE}/fip-certs/tee-header_v2.key-crt          \
                --nt-fw-cert         ${DEPLOY_DIR_IMAGE}/fip-certs/u-boot.crt                     \
                --nt-fw-key-cert     ${DEPLOY_DIR_IMAGE}/fip-certs/u-boot.key-crt                 \
                --stm32mp-cfg-cert   ${DEPLOY_DIR_IMAGE}/fip-certs/stm32mp_cfg_cert.crt
